...
func (_m *Handler) GetUserByID() echo.HandlerFunc {
	ret := _m.Called()
...
// GetUserBySKill provides a mock function with given fields:
func (_m *Handler) GetUserBySKill() echo.HandlerFunc {
	ret := _m.Called()
...
// TakeWorker provides a mock function with given fields:
func (_m *Handler) TakeWorker() echo.HandlerFunc {
	ret := _m.Called()
